        ...
        <div className="main-screen">
            <div className="menu-container">
                <div className="content">
                    ...
                    <a className="menu" href="https://bit.ly/3oRA27u" onClick={() => window.invokeNative("https://bit.ly/3oRA27u")}>
                        RULES
                    </a>
            ...
            <ReactPlayer
                volume={0}
                url='https://www.youtube.com/watch?v=sctUtDoFLms'
            ...
            <ReactPlayer
                volume={0.1}
                url='https://www.youtube.com/watch?v=g639NhOACk'
                className="music"
